...
export const zh = {
  ...
  sessions: {
    ...
    wizard: {
      // 第一步选世界（0017 起会话必有世界，历法与世界观随卡带入，向导不再设历法段）
      stepWorld: '第一步 · 世界',
      pickWorldHint: '选择故事发生的世界——历法与世界观由它决定',
      loadingWorlds: '世界加载中…',
      noWorlds: '还没有世界——先到世界页创建一张世界卡',
      newWorldInline: '新建世界',
      newWorldNamePlaceholder: '世界名，回车即建',
      stepUser: '第二步 · 你的角色',
      pickUserHint: '选择你扮演的角色——这是你在故事中的身份',
      stepRoster: '第三步 · LLM 阵容',
